/*
 * $Id: MyFreemarkerResult.java 724514 2008-12-08 22:17:52Z musachy $
 *
...
package com.izhi.platform.webapp.template;
...
public class MyFreemarkerResult extends StrutsResultSupport {
    ...
    public void doExecute(String locationArg, ActionInvocation invocation) throws IOException, TemplateException {
        ...
        String suit= (String)invocation.getInvocationContext().getApplication().get(Constants.APP_MANAGER_THEME);
        log.debug("模板:"+suit);
        log.debug("LocationArg:"+locationArg);
        if (!locationArg.startsWith("/")) {
            ActionContext ctx = invocation.getInvocationContext();
            HttpServletRequest req = (HttpServletRequest) ctx.get(ServletActionContext.HTTP_REQUEST);
            String base = ResourceUtil.getResourceBase(req);
            
            locationArg = "/WEB-INF/templates/"+suit+base +"/"+ locationArg;
