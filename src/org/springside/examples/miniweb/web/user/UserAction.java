...
import org.springside.examples.miniweb.service.user.IUserManager;
...
@Results( { @Result(name = CRUDActionSupport.RELOAD, location = "user.do?page.pageRequest=${page.pageRequest}", type = "redirect") })
