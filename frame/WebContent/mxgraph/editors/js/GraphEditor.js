/*
 * $Id: GraphEditor.js,v 1.39 2009/09/25 09:51:33 gaudenz Exp $
...
function main()
{
	...
	var tabItems = (window.google && google.gears) ? [library, diagramPanel] : [library];
	...
	// Hides the button which are only used for Google Gears
