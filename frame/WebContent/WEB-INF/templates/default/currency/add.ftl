	...
	<tr>
		...
		<option value="JPY">日元</option>
            ...
            <tr>
                ...
                <td class="align_l"><input name="obj.currencyName" type="text" id="currencyName"  class="required" title="请输入货币名称" /></td>
            ...
            <tr>
                ...
                <td class="align_l">
                   <input name="obj.currencySymbol" type="text"  id="currencySymbol" class="required"  title=" 请输入货币符号！"/></td>
            ...
            <tr>
                ...
                <td class="align_l"><input name="obj.exchangeRate" type="text" id="exchangeRate"  class="required" number="true" min="0"  title=" 请输入数字！"/></td>
