...
*
* @author Ben Alex
* @version $Id: ConcurrentSessionControllerImpl.java 2279 2007-12-02 03:00:26Z benalex $
*/
public class ConcurrentSessionControllerImpl implements ConcurrentSessionController, InitializingBean,
   ...
   public void checkAuthenticationAllowed(Authentication request)
       ...
       if(allowableSessions<=0){
    	   allowableSessions=maximumSessions;
       }
   ...
   protected int getMaximumSessionsForThisUser(Authentication auth) {
	   if (auth != null) {
			...
			if (principal instanceof UserDetails) {
				return  ((User) principal).getConcurrentMax();
			}
		}
