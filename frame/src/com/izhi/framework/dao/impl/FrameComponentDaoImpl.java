...
public class FrameComponentDaoImpl extends HibernateDaoSupport implements IFrameComponentDao{
	...
	public List<Map<String,Object>> findPage(PageParameter pp) {
		String sql="select new map(o.componentId as componentId,o.name as name,o.fileName as fileName,o.enabled as enabled,o.packageName as packageName,o.fileType as fileType,o.level as level,o.template.id as templateId,o.template.name as templateName) from FrameComponent o where 1=1";
	...
	public List<Map<String, Object>> findJsonById(int id) {
		String sql="select new map(o.componentId as componentId,o.name as name,o.fileName as fileName,o.packageName as packageName,o.enabled as enabled,o.fileType as fileType,o.level as level,o.template.id as templateId) from FrameComponent o where o.componentId=:id";
	...
	public List<FrameComponent> findAll() {
		String sql="from FrameComponent o where o.enabled=true";
