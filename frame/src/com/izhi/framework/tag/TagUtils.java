...
public final class TagUtils {
	...
	public static String getGenerateFileName(FrameProject fp,
		...
		try {
			Template fileNameTpl = new Template("fileName", new StringReader(
					templateStr), config);
	...
	public static String getGeneratePackageName(FrameProject fp,
			FrameComponent fc, FrameModel fm) {
		...
		if (fc.getFileType().equals(FrameComponent.TYPE_JAVA)) {
			...
			fpn += getTplResult(fp,fm,fc.getPackageName()) + File.separator;
		}else {
			fpn += fp.getWebPath() + File.separator;
	...
	public static String getTplResult(Map<String,Object> m,String tpl){
		String fn = null;
		Configuration config = new Configuration();
		config.setObjectWrapper(new DefaultObjectWrapper());
		try {
	...
	public static String getTplResult(FrameProject fp, FrameModel fm, String tpl) {
		String fn = null;
		Configuration config = new Configuration();
		config.setObjectWrapper(new DefaultObjectWrapper());
		try {
	...
	public static String getTplResult(FrameProject fp, String tpl) {
		String fn = null;
		Configuration config = new Configuration();
		config.setObjectWrapper(new DefaultObjectWrapper());
		try {
