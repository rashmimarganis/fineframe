...
public class CmsFunctionDaoImpl extends HibernateDaoSupport implements ICmsFunctionDao{
	...
	public List<Map<String, Object>> findPage(PageParameter pp) {
		String sql="select new map(o.modelId as modelId,o.name as name,o.tableName as tableName,o.entityClass as entityClass) from CmsFunction o ";
		if(pp!=null){
			if(pp.getSort()!=null){
	...
	public int findTotalCount() {
		String sql="select count(o) from CmsFunction o";
