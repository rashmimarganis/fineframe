...
@Service("supplierDao")
public class SupplierDaoImpl extends HibernateDaoSupport implements ISupplierDao {

	@Override
	public boolean deleteSupplier(int id) {
		String sql="delete from Supplier o where o.supplierId=? ";
	...
	public boolean deleteSuppliers(List<Integer> ids) {
		String sql="delete from Supplier o where o.supplierId in(:ids)";
	...
	public Supplier findSupplierById(int id) {
		return (Supplier)this.getHibernateTemplate().load(Supplier.class, id);
	}
