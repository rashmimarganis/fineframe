...
<#list objs as obj>
	<tr>
		...
		<td>${obj.sequence}</td>
		<td class="align_c"><a href="#" class="categoryChild" objId="${obj.categoryId}">下级菜单</a>&nbsp;|&nbsp;<a href="#" class="categoryEdit" objId="${obj.categoryId}">编辑</a>&nbsp;|&nbsp;<a href="#" class="categoryDelete" objId="${obj.categoryId}">删除</a></td>
	</tr>
</#list>
</table>
